 ...
 */
#ifndef __REC_TRK_WINDOW_TRACKS_HPP_
#define __REC_TRK_WINDOW_TRACKS_HPP_
...
/**
 * Auto-generated rec_trk_window_tracks structure for the 
 * "/rec.trk.window.tracks" table in corresponding HDF5 files.
 */
struct rec_trk_window_tracks {
     ...
     *    (?) f(uint64_t run, uint64_t subrun, uint64_t event, const rec_trk_window_tracks& value)
     *
    ...
    static void from_hdf5(hid_t file, F&& callback) {
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/leninact", H5P_DEFAULT);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/lenincat", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/avedEdxlast10cm", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/avedEdxlast20cm", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/avedEdxlast30cm", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/avedEdxlast40cm", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/calE", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/cycle", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/dir.x", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/dir.y", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/dir.z", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/enddist", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/len", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/lenE", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/overlapE", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/pngmaxx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/pngmaxy", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/pngminx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/pngminy", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/rec.trk.window.tracks_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/start.x", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/start.y", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/start.z", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/stop.x", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/stop.y", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/stop.z", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/stopdir.x", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/stopdir.y", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/stopdir.z", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/trkbakair", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/trkbakcell", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/trkbakcellnd", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/trkbakdist", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/trkbaksteel", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/trkfwdair", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/trkfwdcell", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/trkfwdcellnd", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/trkfwddist", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/trkfwdsteel", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/trkyposattrans", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/vtxdist", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/maxplanecont", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/maxplanegap", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/nhit", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/nhitx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/nhity", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/nplane", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/nplanegap", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/subevt", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/view", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/run", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/subrun", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.window.tracks/evt", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
