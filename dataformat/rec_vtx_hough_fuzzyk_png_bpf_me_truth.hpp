 ...
 */
#ifndef __REC_VTX_HOUGH_FUZZYK_PNG_BPF_ME_TRUTH_HPP_
#define __REC_VTX_HOUGH_FUZZYK_PNG_BPF_ME_TRUTH_HPP_
...
/**
 * Auto-generated rec_vtx_hough_fuzzyk_png_bpf_me_truth structure for the 
 * "/rec.vtx.hough.fuzzyk.png.bpf.me.truth" table in corresponding HDF5 files.
 */
struct rec_vtx_hough_fuzzyk_png_bpf_me_truth {
    ...
    std::uint32_t rec_vtx_hough_fuzzyk_png_bpf_me_idx; /* rec.vtx.hough.fuzzyk.png.bpf.me_idx column */
    ...
    void serialize(A& ar, const unsigned int version) {
        ...
        ar & pdg;
        ar & pur;
        ar & rec_vtx_hough_fuzzyk_png_bpf_me_idx;
     ...
     *    (?) f(uint64_t run, uint64_t subrun, uint64_t event, const rec_vtx_hough_fuzzyk_png_bpf_me_truth& value)
     *
    ...
    static void from_hdf5(hid_t file, F&& callback) {
        rec_vtx_hough_fuzzyk_png_bpf_me_truth current;
        hid_t dataset;
        hid_t dataspace;
        hsize_t dims[2];
        herr_t err;
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/cycle", H5P_DEFAULT);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/daughterVisE", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/daughterVisEBirks", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/daughterVisEinslc", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/daughterVisEinslcBirks", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/eff", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/motherp.E", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/motherp.px", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/motherp.py", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/motherp.pz", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/motherpdg", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/p.E", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/p.px", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/p.py", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/p.pz", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/pdg", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/pur", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        H5Sclose(dataspace);
        H5Dclose(dataset);
        std::vector<std::uint32_t> col_rec_vtx_hough_fuzzyk_png_bpf_me_idx; /* rec.vtx.hough.fuzzyk.png.bpf.me_idx column */
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/rec.vtx.hough.fuzzyk.png.bpf.me_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        col_rec_vtx_hough_fuzzyk_png_bpf_me_idx.resize(dims[0]);
        err = H5Dread(dataset, H5T_NATIVE_UINT32, H5S_ALL, H5S_ALL, H5P_DEFAULT,
                static_cast<void*>(col_rec_vtx_hough_fuzzyk_png_bpf_me_idx.data()));
        H5Sclose(dataspace);
        H5Dclose(dataset);
        std::vector<std::uint32_t> col_rec_vtx_hough_fuzzyk_png_bpf_idx; /* rec.vtx.hough.fuzzyk.png.bpf_idx column */
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/rec.vtx.hough.fuzzyk.png.bpf_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/rec.vtx.hough.fuzzyk.png_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/rec.vtx.hough_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/start.x", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/start.y", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/start.z", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/trkID", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/visE", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/visEBirks", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/visEinslc", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/visEinslcBirks", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/subevt", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/run", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/subrun", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf.me.truth/evt", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        for(uint64_t i = 0; i < dims[0]; i++) {
            ...
            current.rec_vtx_hough_fuzzyk_png_bpf_me_idx = col_rec_vtx_hough_fuzzyk_png_bpf_me_idx[i];
