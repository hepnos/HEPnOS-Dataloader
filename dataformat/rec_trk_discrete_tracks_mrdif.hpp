 ...
 */
#ifndef __REC_TRK_DISCRETE_TRACKS_MRDIF_HPP_
#define __REC_TRK_DISCRETE_TRACKS_MRDIF_HPP_
...
/**
 * Auto-generated rec_trk_discrete_tracks_mrdif structure for the 
 * "/rec.trk.discrete.tracks.mrdif" table in corresponding HDF5 files.
 */
struct rec_trk_discrete_tracks_mrdif {
     ...
     *    (?) f(uint64_t run, uint64_t subrun, uint64_t event, const rec_trk_discrete_tracks_mrdif& value)
     *
    ...
    static void from_hdf5(hid_t file, F&& callback) {
        rec_trk_discrete_tracks_mrdif current;
        hid_t dataset;
        hid_t dataspace;
        hsize_t dims[2];
        herr_t err;
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/calE", H5P_DEFAULT);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/cycle", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/gap", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/rec.trk.discrete.tracks.mrdif_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/rec.trk.discrete.tracks_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/isDiF", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/isShwDiF", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/maxplanecont", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/maxplanegap", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/nhit", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/nhitx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/nhity", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/nplane", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/nplanex", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/nplaney", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/subevt", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/view", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/run", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/subrun", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.trk.discrete.tracks.mrdif/evt", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
