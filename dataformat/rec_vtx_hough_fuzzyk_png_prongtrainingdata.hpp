 ...
 */
#ifndef __REC_VTX_HOUGH_FUZZYK_PNG_PRONGTRAININGDATA_HPP_
#define __REC_VTX_HOUGH_FUZZYK_PNG_PRONGTRAININGDATA_HPP_
...
/**
 * Auto-generated rec_vtx_hough_fuzzyk_png_prongtrainingdata structure for the 
 * "/rec.vtx.hough.fuzzyk.png.prongtrainingdata" table in corresponding HDF5 files.
 */
struct rec_vtx_hough_fuzzyk_png_prongtrainingdata {
    ...
    std::uint32_t rec_vtx_hough_fuzzyk_png_prongtrainingdata_idx; /* rec.vtx.hough.fuzzyk.png.prongtrainingdata_idx column */
    ...
    void serialize(A& ar, const unsigned int version) {
        ...
        ar & ncellx;
        ar & ncelly;
        ar & rec_vtx_hough_fuzzyk_png_prongtrainingdata_idx;
     ...
     *    (?) f(uint64_t run, uint64_t subrun, uint64_t event, const rec_vtx_hough_fuzzyk_png_prongtrainingdata& value)
     *
    ...
    static void from_hdf5(hid_t file, F&& callback) {
        rec_vtx_hough_fuzzyk_png_prongtrainingdata current;
        hid_t dataset;
        hid_t dataspace;
        hsize_t dims[2];
        herr_t err;
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/pangle", H5P_DEFAULT);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/pgap", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/plength", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/purity3d", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/purityx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/purityy", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/rece", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/vertx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/verty", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/vertz", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/cycle", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/label3d", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/labelx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/labely", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/ncellx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/ncelly", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        H5Sclose(dataspace);
        H5Dclose(dataset);
        std::vector<std::uint32_t> col_rec_vtx_hough_fuzzyk_png_prongtrainingdata_idx; /* rec.vtx.hough.fuzzyk.png.prongtrainingdata_idx column */
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/rec.vtx.hough.fuzzyk.png.prongtrainingdata_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        col_rec_vtx_hough_fuzzyk_png_prongtrainingdata_idx.resize(dims[0]);
        err = H5Dread(dataset, H5T_NATIVE_UINT32, H5S_ALL, H5S_ALL, H5P_DEFAULT,
                static_cast<void*>(col_rec_vtx_hough_fuzzyk_png_prongtrainingdata_idx.data()));
        H5Sclose(dataspace);
        H5Dclose(dataset);
        std::vector<std::uint32_t> col_rec_vtx_hough_fuzzyk_png_idx; /* rec.vtx.hough.fuzzyk.png_idx column */
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/rec.vtx.hough.fuzzyk.png_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/rec.vtx.hough_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/isprimary", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/subevt", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/run", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/subrun", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.prongtrainingdata/evt", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        for(uint64_t i = 0; i < dims[0]; i++) {
            ...
            current.rec_vtx_hough_fuzzyk_png_prongtrainingdata_idx = col_rec_vtx_hough_fuzzyk_png_prongtrainingdata_idx[i];
