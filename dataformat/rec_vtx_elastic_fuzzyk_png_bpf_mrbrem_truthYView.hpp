 ...
 */
#ifndef __REC_VTX_ELASTIC_FUZZYK_PNG_BPF_MRBREM_TRUTHYVIEW_HPP_
#define __REC_VTX_ELASTIC_FUZZYK_PNG_BPF_MRBREM_TRUTHYVIEW_HPP_
...
/**
 * Auto-generated rec_vtx_elastic_fuzzyk_png_bpf_mrbrem_truthYView structure for the 
 * "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView" table in corresponding HDF5 files.
 */
struct rec_vtx_elastic_fuzzyk_png_bpf_mrbrem_truthYView {
     ...
     *    (?) f(uint64_t run, uint64_t subrun, uint64_t event, const rec_vtx_elastic_fuzzyk_png_bpf_mrbrem_truthYView& value)
     *
    ...
    static void from_hdf5(hid_t file, F&& callback) {
        rec_vtx_elastic_fuzzyk_png_bpf_mrbrem_truthYView current;
        hid_t dataset;
        hid_t dataspace;
        hsize_t dims[2];
        herr_t err;
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/cycle", H5P_DEFAULT);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/daughterVisE", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/daughterVisEBirks", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/daughterVisEinslc", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/daughterVisEinslcBirks", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/eff", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/motherp.E", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/motherp.px", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/motherp.py", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/motherp.pz", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/motherpdg", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/p.E", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/p.px", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/p.py", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/p.pz", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/pdg", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/pur", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/rec.vtx.elastic.fuzzyk.png.bpf_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/rec.vtx.elastic.fuzzyk.png_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/rec.vtx.elastic_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/start.x", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/start.y", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/start.z", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/trkID", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/visE", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/visEBirks", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/visEinslc", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/visEinslcBirks", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/subevt", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/run", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/subrun", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.elastic.fuzzyk.png.bpf.mrbrem.truthYView/evt", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
