...
/**
 * Auto-generated rec_vtx_elastic_fuzzyk_png_cvnpart2ViewBal structure for the 
 * "/rec.vtx.elastic.fuzzyk.png.cvnpart2ViewBal" table in corresponding HDF5 files.
 */
struct rec_vtx_elastic_fuzzyk_png_cvnpart2ViewBal {
     ...
     *    (?) f(uint64_t run, uint64_t subrun, uint64_t event, const rec_vtx_elastic_fuzzyk_png_cvnpart2ViewBal& value)
     *
    ...
    static void from_hdf5(hid_t file, F&& callback) {
        rec_vtx_elastic_fuzzyk_png_cvnpart2ViewBal current;
        hid_t dataset;
        hid_t dataspace;
        hsize_t dims[2];
        herr_t err;
