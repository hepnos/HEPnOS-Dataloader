 ...
 */
#ifndef __REC_VTX_HOUGH_FUZZYK_PNG_BPF_HPP_
#define __REC_VTX_HOUGH_FUZZYK_PNG_BPF_HPP_
...
/**
 * Auto-generated rec_vtx_hough_fuzzyk_png_bpf structure for the 
 * "/rec.vtx.hough.fuzzyk.png.bpf" table in corresponding HDF5 files.
 */
struct rec_vtx_hough_fuzzyk_png_bpf {
     ...
     *    (?) f(uint64_t run, uint64_t subrun, uint64_t event, const rec_vtx_hough_fuzzyk_png_bpf& value)
     *
    ...
    static void from_hdf5(hid_t file, F&& callback) {
        rec_vtx_hough_fuzzyk_png_bpf current;
        hid_t dataset;
        hid_t dataspace;
        hsize_t dims[2];
        herr_t err;
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/leninact", H5P_DEFAULT);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/lenincat", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/avedEdxlast10cm", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/avedEdxlast20cm", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/avedEdxlast30cm", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/avedEdxlast40cm", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/calE", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/chi2Hit", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/chi2Scat", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/chi2T", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/cycle", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/dEdXLL", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/dir.x", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/dir.y", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/dir.z", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/enddist", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/energy", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/hitRatio", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/len", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/lenE", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/momentum.x", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/momentum.y", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/momentum.z", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/overlapE", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/pdg", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/pid", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/pngmaxx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/pngmaxy", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/pngminx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/pngminy", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/rec.vtx.hough.fuzzyk.png.bpf_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/rec.vtx.hough.fuzzyk.png_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/rec.vtx.hough_idx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/start.x", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/start.y", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/start.z", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/stop.x", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/stop.y", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/stop.z", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/stopdir.x", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/stopdir.y", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/stopdir.z", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/trkbakair", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/trkbakcell", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/trkbakcellnd", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/trkbakdist", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/trkbaksteel", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/trkfwdair", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/trkfwdcell", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/trkfwdcellnd", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/trkfwddist", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/trkfwdsteel", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/trkyposattrans", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/vtxdist", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/maxplanecont", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/maxplanegap", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/nhit", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/nhitx", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/nhity", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/nplane", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/nplanegap", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/subevt", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/view", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/run", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/subrun", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
        ...
        dataset = H5Dopen(file, "/rec.vtx.hough.fuzzyk.png.bpf/evt", H5P_DEFAULT);
        dataspace = H5Dget_space(dataset);
        ndims = H5Sget_simple_extent_dims(dataspace, dims, NULL);
